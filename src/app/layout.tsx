...
const navLinks = [
  { href: '/', label: 'Home' },
  { href: 'https://satyambro03.github.io/BCA-YCMOU/notes.html', label: 'Notes', external: true },
  { href: 'https://satyambro03.github.io/BCA-YCMOU/question_papers.html', label: 'Question Papers', external: true },
  { href: 'https://satyambro03.github.io/BCA-YCMOU/practicals.html', label: 'Practicals', external: true },
  { href: 'https://satyambro03.github.io/BCA-YCMOU/books.html', label: 'E-Books', external: true },
...
const socialLinks = [
  { href: 'https://www.linkedin.com/in/satyam-vishwakarma-/',
    label: 'LinkedIn',
    icon: () => (
